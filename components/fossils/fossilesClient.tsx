    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          // Délai basé sur l'index pour l'effet de cascade
          setTimeout(() => {
            setIsVisible(true);
          }, index * 100);
...
export default function FossilesClient({
  ...
  return (
    <div className="flex gap-8 min-h-screen py-6">
      {/* Sidebar de filtres fixe avec margin ajouté */}
        ...
        <div className="sticky top-6">
          <Card className="shadow-xl border-0 bg-gradient-to-br from-white to-slate-50/50 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6 p-6">
              ...
              <div className="flex flex-col gap-3 pt-6 border-t border-gradient-to-r from-transparent via-slate-200 to-transparent">
                <Button
