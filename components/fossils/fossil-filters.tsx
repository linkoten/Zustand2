...
export default function FossilesFilters({
  ...
  return (
    <Card className="h-screen shadow-xl border-0 bg-gradient-to-br from-white to-slate-50/50 backdrop-blur-sm flex flex-col">
      {/* Header fixe */}
      <CardHeader className="pb-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-t-lg flex-shrink-0">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              >
                <SelectTrigger className="border-slate-200 focus:border-amber-500 focus:ring-amber-500 bg-white/80 backdrop-blur-sm hover:shadow-md transition-all duration-200">
                  <SelectValue
                    placeholder={dict?.fossils?.allCountries || "Tous les pays"}
                  />
                </SelectTrigger>
                <SelectContent className="border-slate-200 shadow-xl">
                  <SelectItem value="all" className="hover:bg-amber-50">
            ...
            <div className="space-y-3">
              ...
              <Select value={selectedStage} onValueChange={setSelectedStage}>
                <SelectTrigger className="border-slate-200 focus:border-amber-500 focus:ring-amber-500 bg-white/80 backdrop-blur-sm hover:shadow-md transition-all duration-200">
                  <SelectValue
                    placeholder={dict?.fossils?.allStages || "Tous les étages"}
                  />
                </SelectTrigger>
                <SelectContent className="border-slate-200 shadow-xl">
                  <SelectItem value="all" className="hover:bg-amber-50">
      ...
      <CardFooter className="flex flex-col gap-3 p-6 border-t bg-gradient-to-r from-white to-slate-50 flex-shrink-0">
        <Button
