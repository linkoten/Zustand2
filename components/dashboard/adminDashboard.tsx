...
const statusColors = {
  ...
  IN_PROGRESS:
    "bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-800 border-cyan-700/50",
  COMPLETED:
...
const priorityColors = {
  ...
  NORMAL:
    "bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 border-cyan-700/50",
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        <div className="mb-12 text-center">
          <div className="inline-flex items-center gap-3 bg-silex border border-parchemin/10 px-6 py-3 rounded-full shadow-xl mb-6">
            <Crown className="w-5 h-5 text-terracotta animate-glow" />
            ...
            <CardHeader className="border-b border-orange-100 bg-gradient-to-r from-orange-50 to-red-50">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="border-orange-200 text-orange-700 hover:bg-terracotta/20"
                >
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          <div className="flex items-center gap-3">
                            ...
                            <h4 className="font-semibold text-parchemin group-hover:text-orange-700 transition-colors">
                              {request.fossilType}
                            </h4>
                          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4 text-xs text-parchemin/50">
                            ...
                            <span className="text-parchemin/50">•</span>
                        ...
                        <div className="mt-3 text-xs text-parchemin/50">
            ...
            <Card className="border-0 bg-silex/50/80 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-500">
              <CardHeader className="border-b border-parchemin/10 bg-silex border-b border-parchemin/10">
                <CardTitle className="flex items-center gap-3">
                  ...
                  <span className="text-lg font-bold text-parchemin">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {data.recentUsers.slice(0, 5).map((user, index) => (
                    <div
                      key={user.id}
                      className="flex items-center justify-between p-3 rounded-lg hover:bg-cyan-900/30 group transition-colors"
                      style={{ animationDelay: `${index * 100}ms` }}
                    >
                      <div>
                        <p className="font-semibold text-sm text-parchemin">
                          {user.name || "Anonyme"}
                        </p>
                        <p className="text-xs text-parchemin/50">{user.email}</p>
                      </div>
                      <div className="text-right">
                        <Badge
                          variant="outline"
                          className="text-xs bg-cyan-900/20 border-cyan-700/50 text-cyan-300"
                        >
                          {user.role}
                        </Badge>
                        <p className="text-xs text-parchemin/50 mt-1">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {data.recentProducts.slice(0, 5).map((product, index) => (
                    <div
                      key={product.id}
                      className="flex items-center gap-3 p-3 rounded-lg hover:bg-emerald-900/30 group transition-colors"
                      style={{ animationDelay: `${index * 100}ms` }}
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-semibold text-sm text-parchemin truncate">
                          {product.title}
                        </p>
